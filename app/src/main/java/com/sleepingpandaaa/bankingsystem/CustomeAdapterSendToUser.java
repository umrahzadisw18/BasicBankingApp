...
public class CustomeAdapterSendToUser extends RecyclerView.Adapter<ViewHolder> {

    SendToUser SendtoUser;
    List<Model> modelList;
    Context context;

    public CustomeAdapterSendToUser(SendToUser sentoUser, List<Model> modelList) {
