...
public class CustomeAdapterHistory extends RecyclerView.Adapter<ViewHolder> {
    ...
    List<com.sleepingpandaaa.bankingsystem.Model> modelList;
    Context context;

    TextView mTransc_status;

    public CustomeAdapterHistory(com.sleepingpandaaa.bankingsystem.HistoryList historyList, List<com.sleepingpandaaa.bankingsystem.Model> modelList) {
